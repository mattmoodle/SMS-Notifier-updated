...
*/
    ...
    $string['adminheaderapi'] = 'API settings';
    $string['admindescapi'] = 'Set up the API for SMS messaging';
    $string['adminheaderrolesettings'] = 'Role settings';
    $string['admindescrolesettings'] = 'Define the users that can receive SMS';
    $string['adminheaderrolefilter'] = 'Select roles allowed to receive SMS';
    $string['descrolefilter'] = 'Select multiple roles holding CTRL key. Here roles are shown with their shortnames.';
